...
/* harmony import */ var _guards_authenticate_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./guards/authenticate.guard */ "./src/app/guards/authenticate.guard.ts");
...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | components-security-security-module */ "components-security-security-module").then(__webpack_require__.bind(null, /*! ./components/security/security.module */ "./src/app/components/security/security.module.ts")).then(m => m.SecurityModule)
    },
    {
        path: 'security',
        loadChildren: () => __webpack_require__.e(/*! import() | components-security-security-module */ "components-security-security-module").then(__webpack_require__.bind(null, /*! ./components/security/security.module */ "./src/app/components/security/security.module.ts")).then(m => m.SecurityModule)
    ...
    {
        path: 'account',
        canActivate: [_guards_authenticate_guard__WEBPACK_IMPORTED_MODULE_3__["AuthenticateGuard"]],
        loadChildren: () => Promise.all(/*! import() | components-account-module-account-module */[__webpack_require__.e("common"), __webpack_require__.e("components-account-module-account-module")]).then(__webpack_require__.bind(null, /*! ./components/account-module/account.module */ "./src/app/components/account-module/account.module.ts")).then(m => m.AccountModule)
    },
    {
        path: 'client',
        canActivate: [_guards_authenticate_guard__WEBPACK_IMPORTED_MODULE_3__["AuthenticateGuard"]],
        loadChildren: () => Promise.all(/*! import() | components-client-module-client-module-module */[__webpack_require__.e("common"), __webpack_require__.e("components-client-module-client-module-module")]).then(__webpack_require__.bind(null, /*! ./components/client-module/client-module.module */ "./src/app/components/client-module/client-module.module.ts")).then(m => m.ClientModuleModule)
    }
];
...
module.exports = __webpack_require__(/*! /home/gedgonz/project/personal/BlueBank/BlueBlanFrontend/src/main.ts */"./src/main.ts");
