...
var ClientModuleRoutingModule = /** @class */ (function () {
    function ClientModuleRoutingModule() {
    }
    ...
    return ClientModuleRoutingModule;
}());
...
var ClientModuleModule = /** @class */ (function () {
    function ClientModuleModule() {
    }
...
var NewClientComponent = /** @class */ (function () {
    function NewClientComponent(service, toastr, _fb) {
    ...
    NewClientComponent.prototype.newClient = function () {
        var _this = this;
        this.loading = true;
        this.model.name = this.clientForm.value.name;
        this.model.lastname = this.clientForm.value.lastname;
        this.service.newClientService(this.model).subscribe(function (res) {
            _this.model = new _model_client__WEBPACK_IMPORTED_MODULE_2__["client"]();
            _this.loading = false;
    ...
    NewClientComponent.prototype.createForm = function () {
...
//# sourceMappingURL=components-client-module-client-module-module-es5.js.map